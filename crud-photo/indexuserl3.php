...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #24243e">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="./assets/images/logo.jpg" width="80" heigth="80" class="logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a style="color:#ffffff" class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Home</a>
          </li>
          <li class="nav-item">
            <a style="color:#ffffff" class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Cadastrar</a>
          </li>

          <li class="nav-item">
            <a style="color:#ffffff" class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Listar</a>
          </li>
        </ul>
        <form class="d-flex">
          <img src="<?php $foto ?>" />
